...
Organizations can manage students, staff, collaborators, and customers in Globus using the Group feature. Representatives can create groups and subgroups to manage and document associations between related people. With a Group, you can grant access to many people at once for any [Guest Collections](./globus_organization_tutorial.md#how-do-i-create-a-guest-collection)
